...
static char *searchengine = "https://qwant.com/?q=";

static SearchEngine searchengines[] = {
	{ "g", "https://google.com/search?q=%s" },
	{ "w", "https://www.wikipedia.org/search-redirect.php?family=wikipedia&language=es&search=%s&language=es&go=Go" },
...
#define SETPROP(r, s, p) { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "| dmenu -l 10 -fn 'Anonymous Pro-10' -p \"$4\" -w $1)\" && " \
