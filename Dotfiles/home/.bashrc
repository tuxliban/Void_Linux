...
export NNN_BMS='d:~/Dropbox/Trabajo;t:~/Datos/Telegram;D:~/Descargas;s:~/Datos/Capturas;p:~/.local/share/Trash/files;P:~/Datos/.Trash-1000/files'   # Marcadores
export NNN_PLUG='i:sxiv'                        # Plugins
export NNN_USE_EDITOR=1                         # Usar el $EDITOR para abrir archivos de texto
export NNN_COLORS='2631' 	                # Usar un color distinto para cada contexto (pestañas)
...
#alias dbox='rclonesync.py -1 Dropbox: /home/skynet/Datos/Dropbox --check-access --rclone-args -P --checkers=16 --transfers=8 --checksum'
...
alias gvideo='ffmpeg -video_size 1366x768 -framerate 25 -f x11grab -i :0.0 -f pulse -ac 2 -i 1 -c:a libvorbis -b:a 128k video.mp4 -async 1 -vsync 1'	# Grabar video
...
alias dlocal='glibc rclone sync -P --checkers=16 --transfers=8 --checksum /home/skynet/Dropbox Dropbox:'
alias dremote='glibc rclone sync -P --checkers=16 --transfers=8 --checksum Dropbox: /home/skynet/Dropbox'
...
alias pfetch='glibc pfetch'
alias neofetch='glibc neofetch'
